...
module WebAppTheme
  class ThemedGenerator < Rails::Generators::Base
    ...
    class_option :engine,         :type => :string,   :default => 'haml', :desc => 'Specify the template engine'
    class_option :will_paginate,  :type => :boolean,  :default => true, :desc => 'Specify if you use will_paginate'
